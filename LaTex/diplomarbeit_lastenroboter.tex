...
\newpage
	...
	\begin{center}
		\begin{minipage}[t]{0.95\textwidth}
			\includegraphics[scale=0.8]{Pictures/videoübertragung}
	...
	\begin{center}
		\begin{minipage}[t]{0.7\textwidth}
			...
			\captionof{figure}{<hier gute Bildbeschreibung einfügen>}
	...
	\begin{center}
		\begin{minipage}[t]{1\textwidth}
			...
			\captionof{figure}{Statusbox auf der Website}
	...
	\begin{center}
		\begin{minipage}[t]{1\textwidth}
			...
			\captionof{figure}{Statusbox: Verbunden}
			...
			\captionof{figure}{Statusbox: Verbindung getrennt}
	...
	Wir wählten für die Anzahl der Framebuffer 3. Die Anzahl sagt aus, wie viele Bilder gleichzeitig gespeichert werden können. Mehr Framebuffer erhöhen die Bildrate, benötigen jedoch mehr RAM.\\[0.5cm]
	Zum Schluss wird die Kamera mit den konfigurierten Einstellungen initialisiert. Falls bei der Initialisierung ein Fehler auftreten soll, wird dieser in der seriellen Konsole ausgegeben und das Setup abgebrochen.\\[0.5cm]
