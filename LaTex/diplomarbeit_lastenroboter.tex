...
\begin{document}
	...
	\section{Antrieb}
		...
		\begin{minipage}{\textwidth}
			...
			\vspace{10pt}
		\end{minipage}
		Um das Expander-Board zu nutzen, wird die Bibliothek Adafruit MCP23X17 verwendet. Diese Bibliothek ermöglicht eine einfachere Initialisierung und Ansteuerung der MCP-Pins, sodass die GPIOs ähnlich wie die des ESP32 genutzt werden können. Außerdem wird ein Objekt der Klasse Adafruit MCP23X17 erstellt, über das man später auf den Expander zugreifen kann. \\[0.5cm]
		\begin{minipage}{\textwidth}
			\centering
			\includegraphics[scale=1.05]{Pictures/code_libary_motoren}
			\captionof{figure}{\texttt{Adafruit MCP23X17.h}-Bibliothek}
